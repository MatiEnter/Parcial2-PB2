...
public class Extraccion extends TransaccionMonetaria implements Rechazable, Alertable {
	...
	public Extraccion(Integer score, Cliente cliente, Dispositivo dispositivoUsado) {
		super();
		this.score = score;
		this.cliente = cliente;
		this.dispositivoUsado = dispositivoUsado;
	}
